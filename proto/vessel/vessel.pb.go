...
type VesselServiceClient interface {
	FindAvaliable(ctx context.Context, in *Specification, opts ...client.CallOption) (*Response, error)
}
...
func (c *vesselServiceClient) FindAvaliable(ctx context.Context, in *Specification, opts ...client.CallOption) (*Response, error) {
...
type VesselServiceHandler interface {
	FindAvaliable(context.Context, *Specification, *Response) error
}
...
func (h *VesselService) FindAvaliable(ctx context.Context, in *Specification, out *Response) error {
